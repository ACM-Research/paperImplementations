...
conversation1.append({ 'role': 'system', 'content': open_file(os.path.join(os.getcwd(), "Prompt Chat3.txt")) })
conversation2.append({ 'role': 'system', 'content': open_file(os.path.join(os.getcwd(), "Prompt Chat4.txt")) })
